...
FINAL_IMAGE=${DISTDIR}/JogoDaMemoria.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=main.c game.c leds.c buttons.c display.c buzzer.c sensors.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/game.p1 ${OBJECTDIR}/leds.p1 ${OBJECTDIR}/buttons.p1 ${OBJECTDIR}/display.p1 ${OBJECTDIR}/buzzer.p1 ${OBJECTDIR}/sensors.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/game.p1.d ${OBJECTDIR}/leds.p1.d ${OBJECTDIR}/buttons.p1.d ${OBJECTDIR}/display.p1.d ${OBJECTDIR}/buzzer.p1.d ${OBJECTDIR}/sensors.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/game.p1 ${OBJECTDIR}/leds.p1 ${OBJECTDIR}/buttons.p1 ${OBJECTDIR}/display.p1 ${OBJECTDIR}/buzzer.p1 ${OBJECTDIR}/sensors.p1

# Source Files
SOURCEFILES=main.c game.c leds.c buttons.c display.c buzzer.c sensors.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/JogoDaMemoria.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/JogoDaMemoria.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/JogoDaMemoria.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=none  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/JogoDaMemoria.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} ${DISTDIR}/JogoDaMemoria.X.${IMAGE_TYPE}.hex 
